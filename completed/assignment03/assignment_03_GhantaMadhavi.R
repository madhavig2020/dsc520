...
## `height` vs. `earn`
ggplot(data = heights_df, aes(x= height, y= earn)) + geom_point()
## `age` vs. `earn`
ggplot(data = heights_df, aes(x=age, y= earn)) + geom_point()
## `ed` vs. `earn`
ggplot(data = heights_df, aes(x= ed, y= earn)) + geom_point()

## Re-create the three scatterplots and add a regression trend line using
## the `geom_smooth()` function
## `height` vs. `earn`
ggplot(data = heights_df, aes(x= height, y= earn)) + geom_point()+ geom_smooth()
## `age` vs. `earn`
ggplot(data = heights_df, aes(x=age, y= earn)) + geom_point() + geom_smooth()
## `ed` vs. `earn`
ggplot(data = heights_df, aes(x= ed, y= earn)) + geom_point() + geom_smooth()
...
ggplot(data=heights_df, aes(earn)) + geom_histogram()

## Create a histogram of the `earn` variable using `geom_histogram()`
## Use 10 bins
ggplot(data=heights_df, aes(earn)) + geom_histogram(bins =10)
